 ...
 * </ul>
 */
public class RockerRight extends SurfaceView implements Runnable, SurfaceHolder.Callback {
    ...
    public RockerRight(Context context, AttributeSet as) {
        super(context, as);
...
/*        rocker_bg = BitmapFactory.decodeResource(getResources(), R.drawable.rocker_bg1);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_MOVE) {
            ...
            if (listener != null) {
                ...
                listener.onSteeringWheelChanged(ACTION_RUDDER, RockerRight.this.getAngleCouvert(radian));
            }
        }
        //如果手指离开屏幕，则摇杆返回初始位置
        if (event.getAction() == MotionEvent.ACTION_UP) {
    ...
    public float getX()
    {
        ...
        return mWheelRadius+mRockerPosition.x-mCtrlPoint.x;
    ...
    public float getY()
    {
        ...
        return mWheelRadius+mCtrlPoint.y-mRockerPosition.y;
    ...
    public int getXvalue()
    {
        ...
        float value=mCtrlPoint.x-mRockerPosition.x;
        value/=mWheelRadius;
    ...
    {
        float value=mCtrlPoint.y-mRockerPosition.y;
        value/=mWheelRadius;
